...
def sendEmail(request):
    ...
    senderMail = request.POST["senderMail"]
    senderPass = request.POST["senderPass"]
    ...
    server.login(senderMail,senderMail)
